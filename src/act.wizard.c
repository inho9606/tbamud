...
static void do_stat_character(struct char_data *ch, struct char_data *k)
{
  ...
  send_to_char(ch, "힘: [%s%d/%d%s]  지식: [%s%d%s]  지혜: [%s%d%s]  "
	  "민첩: [%s%d%s]  맷집: [%s%d%s]  통솔력: [%s%d%s]  행운: [%s%d%s]  범죄도: [%s%d%s]  스탯포인트: [%s%d%s]\r\n",
...
ACMD(do_wizutil)
{
  ...
  if (!*arg)
    ...
    //  send_to_char(ch, "Rerolled...\r\n");
      ...
      send_to_char(ch, "새로운 스탯: 힘 %d/%d, 지식 %d, 지혜 %d, 민첩 %d, 맷집 %d, 통솔력 %d, 행운 %d\r\n",
